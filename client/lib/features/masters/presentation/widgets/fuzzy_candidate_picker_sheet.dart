          ...
          children: [
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('Select Matching Ledger', style: LedgifyTypography.cardHeader),
                      Text(
                        'Searched: "$queryName"',
                        maxLines: 1,
            ...
            if (candidates.isEmpty)
              const Padding(
                ...
                child: Center(
                  child: Text('No existing ledgers matched closely.', style: TextStyle(fontSize: 13, color: LedgifyColors.secondarySlate)),
                ),
              )
            else
              ...candidates.map((cand) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text(cand.entityName, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14.5)),
                    subtitle: Text('${cand.groupName} • ${cand.primaryClassification}', style: const TextStyle(fontSize: 11.5, color: LedgifyColors.secondarySlate)),
                    trailing: Container(
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('+ Create New Ledger', style: TextStyle(fontWeight: FontWeight.w700)),
                onPressed: () async {
